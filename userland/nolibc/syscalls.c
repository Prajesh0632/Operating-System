...
/*
 * int 0x80 wrappers - the only way a user-space program talks to the
 * kernel. Same shape as system/system_calls.c (kernel side); duplicated
 * here on purpose, see nolibc.h.
 */
